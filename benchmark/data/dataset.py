...
def create_input(dataset,save_path,model):
    ...
    filename = os.path.join(save_path, model+'_GGNNinput.json')
...
def load_dataset(name: str) -> dir:
    ...
    if name in molecule_set:
        ...
        dataset = Devign(root=os.path.join(ROOT_DIR, '..', 'datasets', 'devign'),
                        num_per_class=10000)
        ...
        save_path='/home/devign_dataset/GNNExplainer/'
